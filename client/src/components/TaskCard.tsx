        ...
        <>
            <div className="border border-white-smoke p-4 rounded-md flex flex-col mt-4 justify-start">
                <div className="flex items-center justify-between pb-4">
                    <button className= {`${priorityColor} px-2 py-1 text-xs rounded-md`}>{task.priority}</button>
                ...
                <p className="text-xs py-4">{task.description}</p>
                    ...
                    <div className="flex gap-2">
                        {
                            task.tags.map((tag) => {
                                return (
                                    <span key={tag}>
                                    <button className="bg-green-700 text-white px-2 py-1 text-xs rounded-lg">{tag}</button>
                                    </span>
                                )
                            })
                        }
